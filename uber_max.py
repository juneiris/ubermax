...
class UberMax:
	...
	def plan_route(self, start, start_time, dest, dest_time, th=12, grace_period_seconds=100, soft_margin=0.8):
...
c=datetime.now()
def test():
	planner = UberMax("/Volumes/Transcend/database/")

	next_dests = planner.plan_route((40.745604007043568, -73.986009900815034),  # 40.795675, -73.970410
                        #datetime.now(),
						c,
                        (40.714344, -73.994378),  # (40.6413151, -73.7803278),
                        #datetime.now() + timedelta(hours=4))
						c + timedelta(hours=1.5))
	print next_dests
	print c
